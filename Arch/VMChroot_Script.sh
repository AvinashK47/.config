...
mount --mkdir /dev/sda1 /boot/EFI   # Mount the EFI partition
...
grub-install --target=x86_64-efi --efi-directory=/boot/EFI --bootloader-id=GRUB   # Install GRUB with verbose output and recheck
